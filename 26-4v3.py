...
# If a random number (between 0 and 1) is less than self.epsilon, the agent explores an action
    ...
    def optimize_model(self):
        ...
        # حساب قيم Q للحالة الحالية باستخدام policy_net
        ...
        for i in range(MIN_BATCH_SIZE):
            ...
            #الإجراء يمكن أن يشمل عدة أجهزة (اختيار متعدد)، ونحتاج إلى تجميع  قيم Q
            #المتوسط يعطي وزنًا متساويًا لكل جهاز مختار، مما يتماشى مع تصميم معادلة المكافأة ويضمن استقرار التدريب
